...
public class DynamicPropertiesStore extends TronStoreWithRevoking<BytesCapsule> {
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      ...
      //this.saveWitnessPayPerBlock(32000000000L);
      this.saveWitnessPayPerBlock(1150000000L);
    }

    try {
      this.getWitnessStandbyAllowance();
    } catch (IllegalArgumentException e) {
      this.saveWitnessStandbyAllowance(115_200_000_000_000L);
    }
    ...
    try {
      ...
      this.saveAccountUpgradeCost(9_999_000_000_000L);
    }
    ...
    try {
      ...
      this.saveCreateAccountFee(0L); // 0.1TRX
    }
    ...
    try {
      ...
      this.saveMultiSignFee(1000000000L);
    }
    ...
    try {
      ...
      this.saveTotalStoragePool(100_000_000_000_000_000L);
    }
    ...
    try {
      ...
      this.saveStorageExchangeTaxRate(10000);
    }
